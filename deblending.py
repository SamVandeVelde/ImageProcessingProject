...
def get_a11(instr_beamwidth, target_subindex, nontarget_subindex, locations):
    outer_sum = 0
...
def get_a12(instr_beamwidth, target_subindex, nontarget_subindex, locations):
    outer_sum = 0
    for j in target_subindex:
...
def get_a21(instr_beamwidth, target_subindex, nontarget_subindex, locations):
    outer_sum = 0
...
def get_a22(instr_beamwidth, target_subindex, nontarget_subindex, locations):
    outer_sum = 0
    for j in nontarget_subindex:
        for k in nontarget_subindex:
            outer_sum += get_alpha(locations[j], locations[k], instr_beamwidth)
...
def deblending(locations, meas_flux, target_positions, instr_beamwidth):
    ...
    # to solve: Ax = b
    A = np.zeros((2, 2))
    A[0, 0] = get_a11(instr_beamwidth, target_subindex, nontarget_subindex, locations)
    A[0, 1] = get_a12(instr_beamwidth, target_subindex, nontarget_subindex, locations)
    A[1, 0] = get_a21(instr_beamwidth, target_subindex, nontarget_subindex, locations)
    A[1, 1] = get_a22(instr_beamwidth, target_subindex, nontarget_subindex, locations)
    B = np.zeros((2, 1))
